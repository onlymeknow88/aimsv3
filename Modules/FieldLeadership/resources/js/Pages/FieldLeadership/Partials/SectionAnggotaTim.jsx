    ...
    return (
        <div style={cardStyle}>
                    ...
                    >
                        ...
                        <div style={{ width: "160px", flexShrink: 0 }}>
                            <select
                                value={mem.type}
                                onChange={(e) =>
                                    updateMember(idx, "type", e.target.value)
                                }
                                style={inputStyle}
                            >
            ...
            >
                <Plus size={13} />
                Tambah Anggota
                {limitMember > 0 ? ` (${members.length}/${limitMember})` : ""}
            </button>
        </div>
    );
}
