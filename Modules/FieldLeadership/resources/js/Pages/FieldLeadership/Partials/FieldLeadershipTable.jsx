        ...
        () => [
            {
                ...
                cell: ({ row }) => (
                    <Checkbox
                        ...
                        onCheckedChange={(c) =>
                            handleSelectRow(row.original.id, c)
                        }
                    />
                ),
            },
            ...
            },
            {
                ...
                cell: ({ row }) => (
                    <span style={{ fontSize: "12px" }}>
                        {row.original.area_location_name || "—"}
                    </span>
                ),
            },
            {
            ...
            },
            {
                ...
                cell: ({ row }) => (
                    <span style={{ fontSize: "12px" }}>
                        {row.original.positives_count ||
                            row.original.positives?.length ||
                            "—"}
                    </span>
                ),
            },
            {
                ...
                cell: ({ row }) => (
                    <span style={{ fontSize: "12px" }}>
                        {row.original.risks_count ||
                            row.original.risks?.length ||
                            "—"}
                    </span>
                ),
            },
    ...
    return (
        <div>
            <div className="overflow-x-auto">
                <Table>
                    <TableHeader
                        style={{ backgroundColor: "var(--header-bg, #f8fafc)" }}
                    >
