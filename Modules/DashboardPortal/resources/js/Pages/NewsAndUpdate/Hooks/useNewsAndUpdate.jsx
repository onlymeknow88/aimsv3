...
const BASE_URL = '/api/dashboard-portal/news-and-update';
...
export default function useNewsAndUpdate() {
    // Data
    ...
    const fetchNews = useCallback(async () => {
        ...
        try {
            ...
            if (result && result.data) {
                ...
                setNews(result || []);
                setPagination({ current_page: 1, last_page: 1, total: (result || []).length });
            }
        } catch (e) {
            setError('Gagal memuat data news and update.');
            console.error(e);
        } finally {
            setLoading(false);
        }
