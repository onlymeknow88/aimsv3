...
export default function SafetyPerformanceTable({ records, loading, error, selectedIds, toggleSelectAll, toggleSelectOne, onEdit, onDelete, onToggleVisible, pagination, page, setPage, limit, setLimit }) {
    ...
    const columns = useMemo(() => [
        ...
        { key: 'aifr',   header: 'AIFR',   cell: (row) => fmt(row.aifr) },
        { key: 'ainfr',  header: 'AINFR',  cell: (row) => fmt(row.ainfr) },
        { key: 'lti_fr', header: 'LTI FR', cell: (row) => fmt(row.lti_fr) },
        { key: 'lti_sr', header: 'LTI SR', cell: (row) => fmt(row.lti_sr) },
