import { ClipboardCheck, Eye, RefreshCw, Search } from 'lucide-react';
        ...
        <CSMSLayout>
            ...
            <div style={{ backgroundColor: 'var(--card-bg)', border: '1px solid var(--border-color)', borderRadius: '12px', overflow: 'hidden', boxShadow: 'var(--shadow-sm)' }}>
                    ...
                    {loading ? (
                        ...
                        <div style={{ padding: '40px', textAlign: 'center', color: 'var(--text-secondary)', fontSize: '13px' }}>Tidak ada data post-bidding.</div>
                    ) : (
