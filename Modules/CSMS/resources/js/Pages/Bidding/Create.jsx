...
export default function BiddingCreate() {
        ...
        axios
            ...
            .then((res) => {
                ...
                if (data.master_checklists) {
                    const filtered = (data.master_checklists ?? []).filter(
                        (mc) => mc.criteria === "Bidding",
                    );
                    setChecklists(
                        filtered.map((mc) => ({
                            id: mc.id,
    ...
    const ccows = (masterData.companies ?? []).filter(
        (c) => c.type === "Internal",
    );
    const parentCompanies = (masterData.companies ?? []).filter(
        (c) => c.type !== "Internal",
    );
            ...
            >
                ...
                >
                    ...
                    <div>
                        ...
                        >
                            Isi data perusahaan kontraktor untuk pendaftaran
                            CSMS
                        </p>
                    </div>
                </div>
                            ...
                            <div style={row2}>
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) =>
                                            set("company_site", e.target.value)
                                        }
                                        style={{
                                            ...S.input,
                                            borderColor: errors.company_site
                                                ? "#ef4444"
                                                : "var(--border-color)",
                                        }}
                    ...
                    <div style={{ marginBottom: "32px" }}>
                        ...
                        >
                            <div style={row2}>
                                <div>
                                    <label style={S.label}>
                                        Kriteria Jasa Perusahaan{" "}
                                        <span style={{ color: "#ef4444" }}>
                                            *
                                        </span>
                                    </label>
                                    <select
                                        value={form.service_criteria}
                                        onChange={(e) =>
                                            set(
                                                "service_criteria",
                                                e.target.value,
                                        ...
                                        style={{
                                            ...S.input,
                                            borderColor: errors.service_criteria
                                                ? "#ef4444"
                                                : "var(--border-color)",
                                        }}
                                    >
                                    ...
                                    {errors.service_criteria && (
                                        <span style={S.error}>
                                            {errors.service_criteria[0]}
                                        </span>
                                    )}
                                </div>
                            </div>
