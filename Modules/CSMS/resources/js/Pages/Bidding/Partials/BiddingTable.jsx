...
export default function BiddingTable({ biddings, loading, onDelete, canEdit, canDelete }) {
    if (loading) {
        return <div style={{ padding: '40px', textAlign: 'center', color: 'var(--text-secondary)', fontSize: '13px' }}>Memuat data...</div>;
    }
    if (!biddings.length) {
        return <div style={{ padding: '40px', textAlign: 'center', color: 'var(--text-secondary)', fontSize: '13px' }}>Tidak ada data bidding.</div>;
    }
