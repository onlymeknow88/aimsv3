        ...
        <KoLayout>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '20px', gap: '12px', flexWrap: 'wrap' }}>
                <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
                    ...
                    <select value={status} onChange={e => { setStatus(e.target.value); setPage(1); if (typeof window !== 'undefined') window.history.replaceState(null, '', e.target.value ? `/ko/proposals?status=${encodeURIComponent(e.target.value)}` : '/ko/proposals'); }} style={{ padding: '8px 12px', border: '1px solid var(--border-color)', borderRadius: '6px', fontSize: '12px' }}>
