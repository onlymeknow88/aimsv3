...
export default function OnGoingTable({
    ...
    const columns = useMemo(() => [
        ...
        },
        {
            ...
            cell: ({ row }) => (
                <span >
                        {row.original.document_number || 'DRAFT'}
                </span>
            )
        },
        {
        ...
        },
        {
            ...
            header: 'Status',
            cell: info => {
                const s = info.getValue() ? String(info.getValue()) : '1';
                const statusNames = {
                ...
                const config = statusNames[s] || { text: 'WAITING REVIEW', color: 'var(--accent)', bg: 'rgba(255, 140, 36, 0.08)' };
                return (
                    <span style={{
                        fontSize: '10px',
                        fontWeight: 700,
