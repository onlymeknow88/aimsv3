                ...
                <Table>
                    <TableHeader>
                        <TableRow style={{ backgroundColor: '#f8fafc' }}>
                            ...
                            <TableHead style={{ fontWeight: 700, fontSize: '11px', color: '#475569', textTransform: 'uppercase', padding: '14px 16px' }}>Modul Induk</TableHead>
                            <TableHead style={{ fontWeight: 700, fontSize: '11px', color: '#475569', textTransform: 'uppercase', padding: '14px 16px', textAlign: 'center' }}>Jumlah Mapping</TableHead>
                        ...
                        {loading ? (
                            ...
                            categories.map(cat => (
                                <TableRow key={cat.id} style={{ borderBottom: '1px solid #f1f5f9' }}>
                                    <TableCell style={{ padding: '14px 16px', fontWeight: 700, color: 'var(--primary)', fontFamily: 'monospace' }}>{cat.index}</TableCell>
                                    <TableCell style={{ padding: '14px 16px', fontWeight: 600 }}>{cat.name}</TableCell>
                                    <TableCell style={{ padding: '14px 16px', color: '#475569' }}>{cat.module?.name || '-'}</TableCell>
                                    <TableCell style={{ padding: '14px 16px', textAlign: 'center', color: '#64748b' }}>{cat.mappings_count ?? 0}</TableCell>
