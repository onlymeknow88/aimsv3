                    ...
                    <li style={{ marginBottom: '4px' }}>
                        ...
                        {openMaster && (
                            <ul style={{ listStyle: 'none', margin: '4px 0 0 0', paddingLeft: '28px' }}>
                                ...
                                <li><a href="/document-system/master?tab=permissions" style={{ display: 'block', padding: '6px 12px', fontSize: '12px', color: (currentPath === '/document-system/master' && currentSearch.includes('tab=permissions')) ? '#fff' : '#a3b1c6', textDecoration: 'none' }} className="hover-link">Role & Permission</a></li>
