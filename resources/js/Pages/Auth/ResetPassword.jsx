import { ChevronRight, Eye, EyeOff, Lock, Mail, Loader2, ArrowLeft } from 'lucide-react';
...
export default function ResetPassword({ token, email }) {
    ...
    return (
        <div className="min-h-screen flex flex-col lg:flex-row bg-[#F7F9FC] font-sans antialiased">
            <Head title="AIMS - Atur Ulang Kata Sandi" />
            ...
            {/* Right Column: Reset Card (Responsive Full Width on Mobile, Centered Card) */}
            <div className="w-full lg:w-5/12 xl:w-1/3 flex items-center justify-center p-4 sm:p-6 lg:p-8 xl:p-12 min-h-screen">
                <div className="w-full max-w-md bg-white rounded-2xl p-6 sm:p-8 shadow-xl shadow-slate-200/60 border border-slate-100 transition-all">
                    ...
                    {/* Header Form */}
                    <div className="mb-6">
                        <h3 className="text-xl sm:text-22px font-extrabold text-[#10233F] mb-1">Atur Ulang Kata Sandi</h3>
                    ...
                    <form onSubmit={submit} className="space-y-4">
                        {/* Email Input (Read-only / Hidden / Shown as info) */}
                        <div>
                            ...
                            <div className="relative rounded-lg shadow-sm">
                                ...
                                <input
                                    ...
                                    name="email"
                                    value={data.email}
                                    className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-xs sm:text-sm text-slate-500 outline-none cursor-not-allowed"
