 ...
 * useFieldLeadership
 *
 * Custom hook untuk FieldLeadership widget.
 ...
 */
export default function useFieldLeadership(filters = {}) {
    ...
    const fetchStats = useCallback(async (currentFilters) => {
        ...
        try {
            ...
            const res = await axios.get('/api/dashboard/field-leadership/stats', { params });
