    ...
    return (
        <DashboardLayout>
                ...
                {statsCards.map((c, i) => {
                    ...
                    return (
                        <div key={i} style={{ backgroundColor: '#fff', border: '1px solid var(--border-color)', borderRadius: '12px', padding: '20px', display: 'flex', alignItems: 'center', gap: '16px', boxShadow: 'var(--shadow-sm)', position: 'relative' }}>
                            ...
                            <div>
                                <span style={{ fontSize: '10px', fontWeight: 700, color: 'var(--text-secondary)', textTransform: 'uppercase', display: 'block', marginBottom: '4px' }}>{c.title}</span>
                                <h3 style={{ fontSize: '20px', fontWeight: 800, color: 'var(--text-primary)', margin: 0 }}>{c.value}</h3>
                                <span style={{ fontSize: '10px', color: c.trend.includes('▲') ? 'var(--success)' : 'var(--danger)', fontWeight: 600 }}>{c.trend}</span>
                            </div>
                            <span style={{ position: 'absolute', right: '12px', top: '12px', fontSize: '10px', color: 'var(--text-muted)', cursor: 'help' }}>ⓘ</span>
                        </div>
                    );
                })}
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1.8fr 1.2fr', gap: '24px', marginBottom: '32px' }}>
                ...
                <div style={{
                    ...
                    <div style={{ maxWidth: '70%', position: 'relative', zIndex: 2 }}>
                        <h2 style={{ fontSize: '22px', fontWeight: 800, marginBottom: '12px', lineHeight: 1.3 }}>Utamakan Keselamatan,<br />Ciptakan Masa Depan Tanpa Kecelakaan Kerja</h2>
                        <p style={{ fontSize: '12px', color: '#94a3b8', marginBottom: '24px' }}>Zero Incident • Zero Harm • Zero Compromise</p>
                        <button style={{ backgroundColor: '#fff', color: '#10233f', border: 'none', borderRadius: '6px', padding: '10px 20px', fontSize: '11px', fontWeight: 700, cursor: 'pointer', display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
                ...
                <div style={{ backgroundColor: '#fff', border: '1px solid var(--border-color)', borderRadius: '16px', padding: '24px', boxShadow: 'var(--shadow-sm)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                    <div>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
                            <h4 style={{ fontSize: '13px', fontWeight: 700, color: 'var(--text-primary)', margin: 0 }}>CALENDAR OF EVENT</h4>
                            <a href="#" style={{ fontSize: '10.5px', color: 'var(--primary)', fontWeight: 600, textDecoration: 'none' }}>Lihat Semua</a>
                        </div>
                            ...
                            {[
                                ...
                                <div key={idx} style={{ display: 'flex', gap: '16px', borderBottom: idx !== 4 ? '1px solid var(--border-color)' : 'none', paddingBottom: '10px', alignItems: 'center' }}>
                                    <div style={{ backgroundColor: '#f1f5f9', borderRadius: '8px', padding: '6px 10px', textAlign: 'center', minWidth: '50px' }}>
                                        <span style={{ fontSize: '12px', fontWeight: 800, color: 'var(--primary)', display: 'block' }}>{evt.date.split(' ')[0]}</span>
                                        <span style={{ fontSize: '8px', fontWeight: 700, color: 'var(--text-secondary)', textTransform: 'uppercase' }}>{evt.date.split(' ')[1]}</span>
                                    </div>
                                    <div style={{ flex: 1 }}>
                                        <h5 style={{ fontSize: '11px', fontWeight: 700, color: 'var(--text-primary)', margin: '0 0 2px 0' }}>{evt.title}</h5>
                                        <span style={{ fontSize: '10px', color: 'var(--text-muted)' }}>{evt.dept}</span>
                                    </div>
                                    <span style={{ fontSize: '8px', fontWeight: 800, backgroundColor: `${evt.color}12`, color: evt.color, padding: '2px 6px', borderRadius: '4px' }}>{evt.status}</span>
                                </div>
                            ))}
                        </div>
                    </div>
                    <div style={{ borderTop: '1px solid var(--border-color)', paddingTop: '12px', marginTop: '12px', textAlign: 'center' }}>
                        <a href="#" style={{ fontSize: '10.5px', color: 'var(--primary)', fontWeight: 700, textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '4px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 0.8fr 1fr', gap: '24px', marginBottom: '32px' }}>
                ...
                <div style={{ backgroundColor: '#fff', border: '1px solid var(--border-color)', borderRadius: '16px', padding: '24px', boxShadow: 'var(--shadow-sm)' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                        <h4 style={{ fontSize: '13px', fontWeight: 700, color: 'var(--text-primary)', margin: 0 }}>PRODUCTION YTD</h4>
                        <select style={{ fontSize: '10px', padding: '4px 8px', border: '1px solid var(--border-color)', borderRadius: '4px', outline: 'none' }}>
                ...
                <div style={{ backgroundColor: '#fff', border: '1px solid var(--border-color)', borderRadius: '16px', padding: '24px', boxShadow: 'var(--shadow-sm)', textAlign: 'center', display: 'flex', flexDirection: 'column', justifyContents: 'space-between' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
                        <h4 style={{ fontSize: '13px', fontWeight: 700, color: 'var(--text-primary)', margin: 0 }}>PRODUCTION MTD</h4>
                        <select style={{ fontSize: '10px', padding: '4px 8px', border: '1px solid var(--border-color)', borderRadius: '4px', outline: 'none' }}>
                    ...
                    <div style={{ position: 'relative', height: '110px', margin: '0 auto', width: '160px' }}>
                        ...
                        <div style={{ position: 'absolute', bottom: '10px', left: 0, right: 0, textAlign: 'center' }}>
                            <span style={{ fontSize: '22px', fontWeight: 800, color: 'var(--text-primary)' }}>76%</span>
                        </div>
                    </div>
                    <div style={{ display: 'flex', justifyContent: 'space-around', borderTop: '1px solid var(--border-color)', paddingTop: '12px', marginTop: '10px', fontSize: '10px' }}>
                        <div>
                ...
                <div style={{ backgroundColor: '#fff', border: '1px solid var(--border-color)', borderRadius: '16px', padding: '24px', boxShadow: 'var(--shadow-sm)' }}>
                    <h4 style={{ fontSize: '13px', fontWeight: 700, color: 'var(--text-primary)', marginBottom: '16px', textTransform: 'uppercase' }}>Operational Summary</h4>
                            ...
                            return (
                                <div key={i} style={{ border: '1px solid var(--border-color)', borderRadius: '8px', padding: '10px', display: 'flex', flexDirection: 'column', gap: '6px', minWidth: 0 }}>
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                                        ...
                                        <span style={{ fontSize: '8.5px', fontWeight: 700, color: 'var(--text-secondary)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{c.name.split(' ')[0]}</span>
                                    </div>
                                    <strong style={{ fontSize: '11px', color: 'var(--text-primary)' }}>{c.value.split(' ')[0]}</strong>
                                    <a href="#" style={{ fontSize: '8px', color: 'var(--primary)', fontWeight: 700, textDecoration: 'none' }}>Lihat Detail →</a>
                                </div>
                            );
                        })}
                    </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: '20px', marginBottom: '32px' }}>
                ...
                <div style={{ backgroundColor: '#fff', border: '1px solid var(--border-color)', borderRadius: '12px', padding: '16px', boxShadow: 'var(--shadow-sm)' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '12px' }}>
                        <span style={{ fontSize: '10.5px', fontWeight: 700, color: 'var(--text-primary)' }}>NEWS & UPDATE</span>
                        <a href="#" style={{ fontSize: '9px', color: 'var(--primary)', fontWeight: 700 }}>Lihat Semua</a>
                    </div>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                        <div>
                            <span style={{ fontSize: '8px', color: 'var(--text-muted)' }}>20 Jun 2026</span>
                            <h6 style={{ fontSize: '10px', fontWeight: 700, margin: '2px 0' }}>AIMS Gelar Safety Campaign Q2 2026</h6>
                        </div>
                        <div>
                            <span style={{ fontSize: '8px', color: 'var(--text-muted)' }}>18 Jun 2026</span>
                            <h6 style={{ fontSize: '10px', fontWeight: 700, margin: '2px 0' }}>Audit ISO 45001 Berhasil Tanpa Temuan Mayor</h6>
                        </div>
                    </div>
                </div>
                ...
                <div style={{ backgroundColor: '#fff', border: '1px solid var(--border-color)', borderRadius: '12px', padding: '16px', boxShadow: 'var(--shadow-sm)' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
                        <span style={{ fontSize: '10.5px', fontWeight: 700, color: 'var(--text-primary)' }}>INCIDENT ALERTS</span>
                        <a href="#" style={{ fontSize: '9px', color: 'var(--primary)', fontWeight: 700 }}>Lihat Semua</a>
                    </div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '10px' }}>
                        <span style={{ fontSize: '24px', fontWeight: 800, color: 'var(--danger)' }}>2</span>
                        <span style={{ fontSize: '9px', color: 'var(--text-secondary)' }}>Incident 7 hari terakhir</span>
                    </div>
                ...
                <div style={{ backgroundColor: '#fff', border: '1px solid var(--border-color)', borderRadius: '12px', padding: '16px', boxShadow: 'var(--shadow-sm)' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
                        <span style={{ fontSize: '10.5px', fontWeight: 700, color: 'var(--text-primary)' }}>K3LH ACTIVITIES</span>
                        <a href="#" style={{ fontSize: '9px', color: 'var(--primary)', fontWeight: 700 }}>Lihat Semua</a>
                    </div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '10px' }}>
                        <span style={{ fontSize: '24px', fontWeight: 800, color: 'var(--success)' }}>14</span>
                        <span style={{ fontSize: '9px', color: 'var(--text-secondary)' }}>Kegiatan Bulan Ini</span>
                    </div>
                    <div style={{ fontSize: '9px', color: 'var(--text-secondary)' }}>
                ...
                <div style={{ backgroundColor: '#fff', border: '1px solid var(--border-color)', borderRadius: '12px', padding: '16px', boxShadow: 'var(--shadow-sm)', textAlign: 'center' }}>
                    <span style={{ fontSize: '10.5px', fontWeight: 700, color: 'var(--text-primary)', display: 'block', marginBottom: '12px' }}>STRATEGIC PROJECT</span>
                    ...
                    <span style={{ fontSize: '9px', color: 'var(--text-secondary)' }}>Digitalisasi Sistem K3LH</span>
                </div>

                {/* 5. K3LH Award */}
                <div style={{ backgroundColor: '#fff', border: '1px solid var(--border-color)', borderRadius: '12px', padding: '16px', boxShadow: 'var(--shadow-sm)', textAlign: 'center' }}>
                    <span style={{ fontSize: '10.5px', fontWeight: 700, color: 'var(--text-primary)', display: 'block', marginBottom: '8px' }}>K3LH AWARD</span>
                    <div style={{ color: '#F5A623', marginBottom: '6px' }}>🏆</div>
                    <h6 style={{ fontSize: '10px', fontWeight: 700, margin: '2px 0' }}>Best Safety Performance</h6>
                    <span style={{ fontSize: '8px', color: 'var(--text-muted)' }}>Mining Operation Division</span>
                </div>
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1.5fr 1.2fr 1.3fr', gap: '24px' }}>
                ...
                <div style={{ backgroundColor: '#fff', border: '1px solid var(--border-color)', borderRadius: '16px', padding: '24px', boxShadow: 'var(--shadow-sm)' }}>
                    <h4 style={{ fontSize: '13px', fontWeight: 700, color: 'var(--text-primary)', marginBottom: '16px' }}>SAFETY PERFORMANCE (YTD 2026)</h4>
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '12px' }}>
                        {[
                            ...
                            <div key={idx} style={{ border: '1px solid var(--border-color)', borderRadius: '8px', padding: '10px', textAlign: 'center' }}>
                                <span style={{ fontSize: '9px', color: 'var(--text-secondary)', display: 'block' }}>{s.label}</span>
                                <strong style={{ fontSize: '16px', color: 'var(--text-primary)', display: 'block', margin: '4px 0' }}>{s.val}</strong>
                                <span style={{ fontSize: '8px', color: s.target.includes('▲') ? 'var(--danger)' : 'var(--success)' }}>{s.target}</span>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div style={{ backgroundColor: '#fff', border: '1px solid var(--border-color)', borderRadius: '16px', padding: '24px', boxShadow: 'var(--shadow-sm)' }}>
                    <h4 style={{ fontSize: '13px', fontWeight: 700, color: 'var(--text-primary)', marginBottom: '16px' }}>K3LH PERFORMANCE OVERVIEW</h4>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                        {[
                ...
                <div style={{ backgroundColor: '#fff', border: '1px solid var(--border-color)', borderRadius: '16px', padding: '24px', boxShadow: 'var(--shadow-sm)' }}>
                    <h4 style={{ fontSize: '13px', fontWeight: 700, color: 'var(--text-primary)', marginBottom: '16px' }}>QUICK LINKS</h4>
                        ...
                        {[
                            ...
                            return (
                                <a key={idx} href="#" style={{ border: '1px solid var(--border-color)', borderRadius: '8px', padding: '12px 10px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '6px', textDecoration: 'none', color: 'var(--text-secondary)', transition: 'all 0.2s' }} onMouseEnter={(e) => { e.currentTarget.style.borderColor = 'var(--primary)'; e.currentTarget.style.color = 'var(--primary)'; }} onMouseLeave={(e) => { e.currentTarget.style.borderColor = 'var(--border-color)'; e.currentTarget.style.color = 'var(--text-secondary)'; }}>
                                    <Icon size={16} />
                                    <span style={{ fontSize: '8.5px', fontWeight: 700, textAlign: 'center' }}>{link.label}</span>
                                </a>
                            );
                        })}
                    </div>
