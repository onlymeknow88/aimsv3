...
export default function useActivityLog() {
    ...
    }, [page, limit, search, actionFilter, resourceFilter, dateFrom, dateTo]);
    ...
    const fetchStats = useCallback(async () => {
        try {
            ...
            console.error('Failed to fetch activity logs stats', e);
        }
    }, []);
    ...
    const handleExport = () => {
        ...
        window.location.href = `/api/admin/activity-logs?${queryParams}`;
    };
